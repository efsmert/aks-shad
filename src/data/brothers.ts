...
export const brothers: Brother[] = [
    ...
    createBrother(61, "Caden Bell", "Classes", "Active", "International Business and Finance", 2029, "Boulder, CO", "S26", ["Alumni Outreach and Engagement (Head)"], "Third"),
    ...
    createBrother(38, "Sebastian Kalus", "Co-op", "Active", "Politics, Philosophy, and Economics", 2027, "Shanghai, China", "S24", ["Ritual (Head)"], "Fourth"),
